...
#
# Package FAISS wheel — RTX 40 / Ada Lovelace
...
BUILD_OUTPUT_DIR="build_output_rtx40"
# Codename naming (matches libfaiss-rtx40-*.so / libcuvs-rtx40-*.so):
# faiss-rtx40-${FAISS_CUDA_TAG}. The wheel's manylinux_*_x86_64 platform tag
# still selects x86_64 at install time.
export CUDA_ARCHS="89"
FAISS_VARIANT="${FAISS_VARIANT:-rtx40-${FAISS_CUDA_TAG}}"
PY_VER=$(${PYTHON} -c "import sys; print(f'{sys.version_info.major}{sys.version_info.minor}')")
BUILD_DIR="_build_python_rtx40_${PY_VER}"

echo "========================================="
echo "Packaging FAISS Wheel (RTX 40)"
echo "========================================="
...
# Verify build exists
if [ ! -d "$BUILD_DIR" ]; then
    echo "ERROR: Build directory not found. Run build_pkg_rtx40.sh first."
    exit 1
fi
...
if command -v auditwheel &> /dev/null; then
    ...
    export LD_LIBRARY_PATH="${FAISS_ROOT}/_libfaiss_stage_rtx40/lib:/opt/intel/oneapi/mkl/latest/lib:${CUDA_HOME}/lib64:$LD_LIBRARY_PATH"
...
echo ""
echo "========================================="
echo "✓ Wheel packaging complete (RTX 40)"
echo "========================================="
